...
func main() {
	...
	flag.StringVar(&historyDBPath, "history-db-path", "/var/lib/ai-pipelines/history.db",
		"Path to the SQLite database for tracking completed issues.")
	flag.StringVar(&logFilePath, "log-file", "",
		"Path to write logs to (in addition to stderr). Useful for local dev.")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7a1d068e.aipipelines.io",
